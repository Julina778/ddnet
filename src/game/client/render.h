...
public:
	...
	void RenderGameTileOutlines(CTile *pTiles, int w, int h, float Scale, int TileType) const; // Alesstya1
	void RenderTeleOutlines(CTile *pTiles, CTeleTile *pTele, int w, int h, float Scale) const; // Alesstya2
};
