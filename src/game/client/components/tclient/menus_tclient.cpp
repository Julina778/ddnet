...
void CMenus::RenderSettingsTClientSettngs(CUIRect MainView)
{
	...
	if(g_Config.m_ClNotifyWhenLast)
	{
		...
		Column.HSplitTop(LineSize, &Button, &Column);
		Ui()->DoScrollbarOption(&g_Config.m_ClNotifyWhenLastXpos, &g_Config.m_ClNotifyWhenLastXpos, &Button, TCLocalize("X Position"), 1, 100);
		Column.HSplitTop(LineSize, &Button, &Column);
		Ui()->DoScrollbarOption(&g_Config.m_ClNotifyWhenLastYpos, &g_Config.m_ClNotifyWhenLastYpos, &Button, TCLocalize("Y Position"), 1, 100);
		Column.HSplitTop(LineSize, &Button, &Column);
