...
#define CONFIG_DOMAIN(Name, ConfigPath, HasVars) Name, // Alesstya1
...
public:
	...
	virtual void RegisterCallback(SAVECALLBACKFUNC pfnFunc, void *pUserData, ConfigDomain ConfigDomain = ConfigDomain::DDNET) = 0; // Alesstya1

	virtual void WriteLine(const char *pLine, ConfigDomain ConfigDomain = ConfigDomain::DDNET) = 0; // Alesstya2
