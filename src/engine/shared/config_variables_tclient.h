...
MACRO_CONFIG_INT(ClNotifyWhenLastXpos, tc_last_notify_xpos, 20, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "X position for last notify")
MACRO_CONFIG_INT(ClNotifyWhenLastYpos, tc_last_notify_ypos, 10, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Y position for last notify")
