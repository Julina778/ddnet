...
CConfigManager::CConfigManager()
{
	m_pConsole = nullptr;
	m_pStorage = nullptr;
	for(ConfigDomain ConfigDomain = ConfigDomain::START; ConfigDomain < ConfigDomain::NUM; ++ConfigDomain) // Alesstya1
	{
...
void CConfigManager::Init()
{
	...
	ConfigDomain ConfigDomain; // Alesstya1
	const auto &&AddVariable = [this, &ConfigDomain](SConfigVariable *pVariable) {
		pVariable->m_ConfigDomain = ConfigDomain; // Alesstya2
...
#define SET_CONFIG_DOMAIN(_ConfigDomain) ConfigDomain = _ConfigDomain; // Alesstya1
#include "config_includes.h" // Alesstya2
...
bool CConfigManager::Save()
{
	...
	bool aFailedError[ConfigDomain::NUM] = {}; // Alesstya1
