...
#endif
{
	...
	// execute config file
	pConsole->SetUnknownCommandCallback(SaveUnknownCommandCallback, pClient); // Alesstya1
	...
	pConsole->SetUnknownCommandCallback(IConsole::EmptyUnknownCommandCallback, nullptr); // Alesstya2
